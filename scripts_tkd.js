...
function addToCart(id, name, price) {
    ...
    if (existingProduct) {
        ...
        alert("Producto Aregado al Carrito ");
...
function displayCart() {
    ...
    cart.forEach(product => {
        ...
        li.textContent = `${product.name} x ${product.quantity} - $${(product.price * product.quantity).toFixed(3)}`;
    ...
    document.getElementById('cart-total').textContent = `Total: $${total.toFixed(3)} COP`;
}
